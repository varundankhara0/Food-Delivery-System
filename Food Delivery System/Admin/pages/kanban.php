...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <script>
    $(function() {
      ...
      $('.swalDefaultAccept').click(function() {
        Toast.fire({
          icon: 'success',
          title: 'This Complain has been Accepted.'
        })

      });

      $('.swalDefaultComplete').click(function() {
        Toast.fire({
          icon: 'success',
          title: 'This Complain has been Completed Successfully.'
        })
      ...
      $('.swalDefaultReject').click(function() {
        Toast.fire({
          icon: 'error',
          title: 'This Complain has been rejected.'
        })
      });
