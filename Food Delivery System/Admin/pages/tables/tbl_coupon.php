        ...
        <div class="container-fluid">
          ...
          <th>Action</th>
                    ...
                    <tbody>
                      ...
                      $query = "SELECT
            tbl_coupon.id,
            tbl_coupon.couponcode,
            tbl_coupon.discount,
            tbl_coupon.maxuses,
            tbl_coupon.status,
            tbl_category.CategoryName,
            tbl_restaurant.Name AS RestaurantName
          FROM
            tbl_coupon
          JOIN
            tbl_category ON tbl_coupon.categoryid = tbl_category.id
          JOIN
            tbl_restaurant ON tbl_coupon.restaurantid = tbl_restaurant.id";
