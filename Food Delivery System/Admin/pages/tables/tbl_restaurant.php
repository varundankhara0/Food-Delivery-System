                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td><?php echo $row["Licesnseno"]; ?></td>
                            <td><a target="blank" href="<?php echo convertToWebPath($row["Licesnseimage"]); ?>">Click here</a></td>
                            <td><?php echo $row["OpeningTime"]; ?></td>
                            <td><?php echo $row["ClosingTime"]; ?></td>
