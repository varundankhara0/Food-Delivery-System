        ...
        <div class="container-fluid">
          ...
          <th>Action</th>
                    ...
                    <tbody>
                      ...
                      $query = "SELECT
            tbl_complaint.id,
            tbl_complaint.orderid,
            tbl_complaint.description,
            tbl_complaint.role,
            tbl_complaint.image AS ComplaintImage,
            tbl_complaint.completionstatus,
            tbl_user.fullname
          FROM
            tbl_complaint
          JOIN
            tbl_user ON tbl_complaint.userid = tbl_user.id";
              ...
              <td><a target="blank" href="<?php echo convertToWebPath($row[" ComplaintImage"]); ?>">Click here</a></td>
