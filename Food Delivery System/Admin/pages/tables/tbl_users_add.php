...
<body class="hold-transition sidebar-mini">
  <div class="wrapper">
    ...
    tbl_customer_address.doorno,
    tbl_customer_address.address,
    tbl_customer_address.type,
    tbl_customer_address.status,
    tbl_user.fullname,
    tbl_area.name
FROM
    tbl_customer_address
JOIN
    tbl_user ON tbl_customer_address.userid = tbl_user.id
JOIN
    tbl_area ON tbl_customer_address.areaid = tbl_area.id;
";
