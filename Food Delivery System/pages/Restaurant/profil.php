...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            ...
            <button id="home" class="btn btn-primary profile-button">Home</button>
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <button class="btn btn-primary profile-button" type="button" id="logout">Logout</button>
            </div>
        </div>
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    <input type="text" name="beforeemail" value="<?php echo htmlspecialchars($row["address"]); ?>" hidden>
                    <div class="col-md-12">
